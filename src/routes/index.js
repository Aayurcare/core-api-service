...
const adminCustomerAccountRoutes = require("./admin/customers/accounts/adminCustomerAccountRoutes");
...
module.exports.registerRoutes = (app) => {
  ...
  app.use("/v1/admin/customers/accounts", adminCustomerAccountRoutes);
